...
public class ShiroUtils {
     ...
     * 在Session中添加踢出登陆的标识。
     */
    public static final String ONLINE_KICKED_OUT_USER = "ONLINE_KICKED_OUT_USER";
    /**
     * 更新登陆用户信息
     */
    public static final String ONLINE_UPDATE_USER = "ONLINE_UPDATE_USER";
    public static final String ONLINE_UPDATE_SESSION_USER_INFO = "ONLINE_UPDATE_SESSION_USER_INFO_";
    ...
    public static Map<String, String> generateAnonDefinitionMap(){
        ...
        //欢迎页面
//        filterChainDefinitionMap.put("/welcome", "user");
//        filterChainDefinitionMap.put("/platform/getChildrenMenu", "user");
     ...
     */
    public static void updateLoginUser(AdminUserDTO userInfo) {
    ...
    public static AdminUserDTO getLoginUser() {
        return (AdminUserDTO) SecurityUtils.getSubject().getPrincipal();
    }
