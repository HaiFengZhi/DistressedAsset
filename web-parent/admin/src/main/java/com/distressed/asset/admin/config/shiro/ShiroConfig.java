...
import com.distressed.asset.admin.config.shiro.filter.KickoutSessionControlFilter;
import com.distressed.asset.admin.config.shiro.filter.RememberAuthenticationFilter;
import com.distressed.asset.admin.config.shiro.filter.ShiroPermissionsFilter;
...
public class ShiroConfig {
    ...
    private static final String CACHE_KEY = "shiro:admin:cache:";
    private static final String SESSION_KEY = "shiro:admin:session:";
