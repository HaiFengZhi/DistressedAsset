...
(function () {
    ...
    function za(a, b, c, d) {
        var e = M.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] ||
            "").length : isNaN(b = O(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c,
            d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(A(a = O(a).toFixed(f))),
    ...
    var v, z = document, N = window, R = Math, u = R.round, P = R.floor, wa = R.ceil, r = R.max, C = R.min, O = R.abs,
        ...
        ra = /msie/i.test(Ea) && !Nb, eb = z.documentMode === 8, fb = /AppleWebKit/.test(Ea), gb = /Firefox/.test(Ea),
        Ob = /(Mobile|Android|Windows Phone)/.test(Ea), xa = "http://www.w3.org/2000/svg",
        Z = !!z.createElementNS && !!z.createElementNS(xa, "svg").createSVGRect,
        Ub = gb && parseInt(Ea.split("Firefox/")[1], 10) < 4, $ = !Z && !ra && !!z.createElement("canvas").getContext,
        Va, hb = z.documentElement.ontouchstart !== v, Pb = {}, yb = 0, cb, M, Xa, Da, zb, H, ya = function () {
        }, Fa = [], Ca = "div", S = "none", Qb = "rgba(192,192,192," + (Z ? 1.0E-4 : 0.002) + ")", Db = "millisecond",
        nb = "second", Ya = "minute", Qa = "hour", sa = "day", Za = "week", Ra = "month", ta = "year",
        Rb = "stroke-width", bb, ob, pb, rb, Sa, $a, ab, Fb, Gb, qb, Hb, Ib, aa = {};
    N.Highcharts = N.Highcharts ? ja(16, !0) : {};
    Xa = function (a, b, c) {
        if (!t(b) || isNaN(b)) return "Invalid date";
        var a =
                p(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b), e, f = d[pb](), g = d[rb](), h = d[Sa](), i = d[$a](),
            j = d[ab](), k = M.lang, l = k.weekdays, d = s({
                a: l[g].substr(0, 3),
                A: l[g],
                d: Aa(h),
                e: h,
    ...
    X && X.init.call(X, zb);
    var ib = F.adapterRun, Vb = F.getScript, oa = F.inArray, n = F.each, sb = F.grep, Wb = F.offset, Na = F.map,
        J = F.addEvent, ba = F.removeEvent, K = F.fireEvent, Sb = F.washMouseEvent, Ab = F.animate, Wa = F.stop,
    ...
    M = {
        ...
        credits: {
            enabled: !0,
            text: "http://z77z.oschina.io/",
            href: "http://z77z.oschina.io/",
    ...
    Ga.prototype = {
        Element: va, init: function (a, b, c, d) {
            ...
            var i = this.label(a, b, c, null, null, null, null, null, "button"), j = 0, k, l, m, o, q, n,
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = W(f), j = ca(f),
                    k = W(g), g = ca(g), e = e.end - f < Ma ? 0 : 1;
                return ["M", a +
            ...
            var o = this, q = o.g(i), p = o.text("", 0, 0, g).attr({zIndex: 1}), y, V, r = 0, da = 3, jb = 0, Oa, E, G,
                I, B = 0, kb = {}, w, g = q.attrSetters, A;
            J(q, "add", m);
            g.width = function (a) {
                Oa = a;
                return !1
    ...
    if (!Z && !$) {
        Highcharts.VMLElement = D = {
            init: function (a, b) {
                ...
                var c, d, e, f = this.element || {}, g = f.style, h = f.nodeName, i = this.renderer,
                    j = this.symbolName, k, l = this.shadows, m, o = this.attrSetters, q = this;
                ea(a) && t(b) && (c = a, a = {}, a[c] = b);
                if (ea(a)) c = a, q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a) if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                    ...
                    if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), m = !0; else if (c === "d") {
                        ...
                        g[c] = d;
                        m = !0
                    } else if (c === "zIndex") d && (g[c] = d), m = !0; else if (oa(c, ["x", "y", "width", "height"]) !==
        ...
        var ma = {
            Element: D, isIE8: Ea.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, o, q, p, y, r, t = "", a = a.stops, u, v = [],
                        s = function () {
                    ...
                    if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - R.atan((m - a) / (o - c)) * 180 / Ma) + '"', s(); else {
                        var j = m.r, E = j * 2, G = j * 2, I = m.cx, B = m.cy, x = b.radialReference, w,
                            j = function () {
                                x && (w =
    ...
    La.prototype = {
        addLabel: function () {
            var a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories,
                ...
                j = g === i[0], k = g === i[i.length - 1], f = e ? p(e[g], f && f[g], g) : g, e = this.label,
                i = i.info, l;
            ...
            var i = this.axis, j = i.transA, k = i.reversed, l = i.staggerLines,
                ...
                o = e.rotation, a = a + e.x - (f && d ? f * j * (k ? -1 : 1) : 0),
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label,
                j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick",
                q = e[m + "LineWidth"], n = e[m +
                "LineColor"], y = e[m + "LineDashStyle"], r = e[o + "Length"], m = e[o + "Width"] || 0, t = e[o + "Color"],
                u = e[o + "Position"], o = this.mark, s = k.step, w = !0, E = d.tickmarkOffset,
                G = this.getPosition(g, j, E, b), I = G.x, G = G.y,
                B = g && I === d.pos + d.len || !g && G === d.pos ? -1 : 1, x = d.staggerLines;
            this.isActive = !0;
            if (q) {
    ...
    tb.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label,
                h = e.width, i = e.to, j = e.from, k = t(j) && t(i), l = e.value, m = e.dashStyle, o = a.svgElem,
                q = [], n, y = e.color, u = e.zIndex, s = e.events, v = b.chart.renderer;
    ...
    Mb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative,
                g = c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = O(g -
    ...
    db.prototype = {
        ...
        translate: function (a, b,
                             c, d, e, f) {
            var g = this.len, h = 1, i = 0, j = d ? this.oldTransA : this.transA, d = d ? this.oldMin : this.min,
        ...
        setTickPositions: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked,
                ...
                m = d.minTickInterval, o = d.tickPixelInterval, q = b.categories;
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz,
                h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k = 0, l, m = 0, o = d.title, q = d.labels, la = 0,
                y = b.axisOffset, u = b.clipOffset, s = [-1, 1, 1, -1][h], w, x = 1, A = p(q.maxStaggerLines, 5), E, G,
                I, B;
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options,
                e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks,
                k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, o = d.alternateGridColor,
                q = a.tickmarkOffset, p = d.lineWidth, y, r = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin);
            y = a.hasData;
    ...
    vb.prototype = {
        init: function (a,
            ...
            var h = this.chart, i = a ? "x" : "y", j = a ? "X" : "Y", k = "chart" + j, l = a ? "width" : "height",
                m = h["plot" + (a ? "Left" : "Top")], o, q, p = 1, n = h.inverted, r = h.bounds[a ? "h" : "v"],
                u = b.length === 1, t = b[0][k], s = c[0][k], w = !u && b[1][k], v = !u && c[1][k], x, c = function () {
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip && c.tooltip.options.followTouchMove,
                ...
                j = b.zoomVert || b.pinchVert, k = i || j, l = b.selectionMarker, m = {}, o = {};
            ...
            if (a.type ===
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(a.dataMin),
                        f = a.toPixels(a.dataMax), g = C(e, f), e = r(e, f);
                    b.min = C(a.pos, g - d);
    ...
    wb.prototype = {
        init: function (a, b) {
            ...
            var c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol,
                g = this.itemHiddenStyle.color, c = b ? c.itemStyle.color : g, h = b ? a.color : g,
                g = a.options && a.options.marker, i = {stroke: h, fill: h}, j;
        ...
        positionCheckboxes: function (a) {
            ...
            var b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth,
                ...
                l = f ? p(e.itemDistance, 8) : 0, m = !e.rtl, o = e.width, q = e.itemMarginBottom || 0,
                n = b.itemMarginTop, y = b.initialItemX, u = a.legendItem, t = a.series || a, s = t.options,
                w = s.showCheckbox, v = e.useHTML;
        ...
        showResetZoom: function () {
            ...
            n(b === "xy" ? [1, 0] : [1], function (b) {
                var d = a[b ? "chartX" : "chartY"], h = c[b ?
                    "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" : "mouseDownY"], j = (h.pointRange || 0) / 2,
            ...
            var a = this.options.chart, b = a.spacingTop, c = a.spacingRight, d = a.spacingBottom, a = a.spacingLeft, e,
                ...
                j = this.optionsMarginBottom, k = this.options.legend, l = p(k.margin, 10), m = k.x, o = k.y,
                q = k.align, u = k.verticalAlign, y = this.titleOffset;
            this.resetMargins();
            e = this.axisOffset;
            ...
            var b = this.inverted, c = this.renderer, d = this.chartWidth, e = this.chartHeight, f = this.options.chart,
                g = f.spacingTop, h = f.spacingRight, i = f.spacingBottom, j = f.spacingLeft, k = this.clipOffset, l, m,
                o, q;
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                e = this.chartBackground, f = this.plotBackground,
                g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor,
                k = a.plotBackgroundColor, l = a.plotBackgroundImage, m = a.plotBorderWidth || 0, o, q = this.plotLeft,
                p = this.plotTop, n = this.plotWidth, r = this.plotHeight, u = this.plotBox, t = this.clipRect,
                s = this.clipBox;
            o = i + (a.shadow ? 8 : 0);
    ...
    Pa.prototype = {
        ...
        onMouseOver: function (a) {
            ...
            var b = this.plotX, c = this.plotY, d = this.series, e = d.options.states,
                ...
                g = f && !f.enabled, h = f && f.states[a], i = h && h.enabled === !1, j = d.stateMarkerGraphic,
                k = this.marker || {}, l = d.chart, m = this.pointAttr, a = a || "";
    ...
    Q.prototype = {
        ...
        setStackedPoints: function () {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                var a = this.processedXData, b = this.processedYData, c = b.length, d = this.options, e = d.threshold,
                    f = d.stack, d = d.stacking, g = this.stackKey, h = "-" + g, i = this.yAxis, j = i.stacks,
                    k = i.oldStacks, l = i.stackExtremes, m, o, q, p, n;
                for (q = 0; q < c; q++) {
                    p = a[q];
                    n = b[q];
        ...
        getExtremes: function () {
            var a = this.yAxis, b = this.stackKey, c, d, e = this.options, f = a.isLog ? null : e.threshold,
                g = this.processedXData, h = this.processedYData, i = h.length, j = [],
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || qa(i), k = a.threshold, a = 0; a < g; a++) {
                var l = f[a], m = l.x, o = l.y, q = l.low,
                    n = e.stacks[(this.negStacks && o < k ? "-" : "") + this.stackKey], r;
        ...
        tooltipHeaderFormatter: function (a) {
            var b = this.tooltipOptions, c = b.xDateFormat, d = b.dateTimeLabelFormats, e = this.xAxis,
                f = e && e.options.type === "datetime", b =
        ...
        alignDataLabel: function (a, b, c, d, e) {
            var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), a = b.getBBox(),
        ...
        clipNeg: function () {
            var a = this.options, b = this.chart, c = b.renderer,
                d = a.negativeColor || a.negativeFillColor, e, f = this.graph, g = this.area, h = this.posClip,
                i = this.negClip;
            e = b.chartWidth;
        ...
        drawTracker: function () {
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length,
                ...
                l = k && {cursor: k}, k = a.singlePoints, m, o = function () {
    ...
    D = ha(Q, {
        ...
        getColumnMetrics: function () {
            ...
            var c = C(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange ||
                1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth,
                b = t(l) ? (k - l) / 2 : k * b.pointPadding, l = p(l, k - 2 * b);
        ...
        translate: function () {
            var a = this.chart, b = this.options, c = b.borderWidth, d = this.yAxis,
                e = this.translatedThreshold = d.getThreshold(b.threshold), f = p(b.minPointLength, 5),
                b = this.getColumnMetrics(), g = b.width, h = this.barW = wa(r(g, 1 + 2 * c)),
                i = this.pointXOffset = b.offset, j = -(c % 2 ? 0.5 : 0), k = c % 2 ? 0.5 : 1;
            a.renderer.isVML &&
            a.inverted && (k += 1);
            Q.prototype.translate.apply(this);
            n(this.points, function (a) {
                var b = C(r(-999, a.plotY), d.len + 999), c = p(a.yBottom, e), n = a.plotX + i, t = h, s = C(b, c), w,
                    b = r(b, c) - s;
    ...
    X = {
        ...
        getCenter: function () {
            var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c,
                ...
                a = [p(b[0], "50%"), p(b[1], "50%"), a.size || "100%", a.innerSize || 0], g = C(e, f), h;
            return Na(a,
                function (a, b) {
                    h = /%$/.test(a);
                    d = b < 2 || b === 2 && h;
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h,
                i = this.startAngleRad = Ma / 180 * ((c.startAngle || 0) % 360 - 90), j = this.points, k = 2 * Ma,
        ...
        drawDataLabels: function () {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10),
                g = p(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = p(e.softConnector, !0),
                l = e.distance, m = a.center, o = m[2] / 2, q = m[1], t = l > 0, s, w, v, x, A = [[], []], z, E, G, I,
                B, C = [0, 0, 0, 0], H = function (a, b) {
                    return b.y - a.y
                }, K = function (a, b) {
                    a.sort(function (a, c) {
